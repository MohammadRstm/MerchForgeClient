export const apiRoutes = {
    ...
    DASHBOARD_BUSINESS_ORDER_ANALYTICS : (businessId : string) => `/Dashboard/businesses/${businessId}/orders/analytics`,
    DASHBOARD_BUSINESS_RECENT_ORDERS : (businessId : string) => `/Dashboard/businesses/${businessId}/orders/recent`,
    DASHBOARD_BUSINESS_INVENTORY_SUMMARY : (businessId : string) => `/Dashboard/businesses/${businessId}/inventory/summary`,
    DASHBOARD_BUSINESS_PRODUCT_PERFORMANCE : (businessId : string) => `/Dashboard/businesses/${businessId}/products/performance`,
    DASHBOARD_BUSINESS_CUSTOMER_SNAPSHOT : (businessId : string) => `/Dashboard/businesses/${businessId}/customers/snapshot`,
    ...
    DASHBOARD_DISABLE_USER : (userId : string) => `/Dashboard/users/${userId}/disable`,
    DASHBOARD_ENABLE_USER : (userId : string) => `/Dashboard/users/${userId}/enable`,
    DASHBOARD_REVOKE_ALL_SESSIONS : "/Dashboard/sessions/revoke-all",
    DASHBOARD_AUDIT_LOGS : "/Dashboard/audit-logs",
    DASHBOARD_SECURITY_OVERVIEW : "/Dashboard/security/overview",
    DASHBOARD_SECURITY_FAILED_LOGINS : "/Dashboard/security/failed-logins",
    DASHBOARD_SECURITY_ALERTS : "/Dashboard/security/alerts",
    DASHBOARD_CUSTOMERS : "/Dashboard/customers",
    DASHBOARD_CUSTOMER_STATS : "/Dashboard/customers/stats",
    DASHBOARD_CUSTOMER_GROWTH : "/Dashboard/customers/growth",
    DASHBOARD_CUSTOMER_TOP : "/Dashboard/customers/top",
    DASHBOARD_CUSTOMER_DISTRIBUTION : "/Dashboard/customers/distribution",
    DASHBOARD_CUSTOMERS_RECENT : "/Dashboard/customers/recent",
    DASHBOARD_CUSTOMER_DETAIL : (customerId : string) => `/Dashboard/customers/${customerId}`,
    DASHBOARD_CUSTOMER_REVOKE_SESSIONS : (customerId : string) => `/Dashboard/customers/${customerId}/revoke-sessions`,
    DASHBOARD_CUSTOMER_ORDERS : (customerId : string) => `/Dashboard/customers/${customerId}/orders`,
    DASHBOARD_CUSTOMER_SPEND_OVER_TIME : (customerId : string) => `/Dashboard/customers/${customerId}/spend-over-time`,
    DASHBOARD_BUSINESS_OPTIONS : "/Dashboard/businesses/options",
    ...
    DASHBOARD_WEBSITE_TEMPLATE_REACTIVATE : (templateId : string) => `/Dashboard/website-templates/${templateId}/reactivate`,
    DASHBOARD_TEMPLATE_STATS : "/Dashboard/website-templates/stats",
    DASHBOARD_TEMPLATE_DOMAIN_SUMMARY : "/Dashboard/website-templates/domain-summary",
    DASHBOARD_REQUESTED_TEMPLATES : "/Dashboard/website-templates/requested",
    DASHBOARD_TEMPLATE_REQUEST_TREND : "/Dashboard/website-templates/request-trend",
